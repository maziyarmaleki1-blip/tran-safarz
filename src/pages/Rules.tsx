      ...
      content: (
        <>
          ...
          <div className="bg-primary/5 rounded-lg p-3 border border-primary/10 mt-3">
            <p className="font-semibold text-foreground text-sm">⚠️ ثبت درخواست در سفرز به معنای تضمین یا قطعیت صدور بلیط نیست.</p>
          </div>
          ...
          <p className="mt-3">سفرز صرفاً یک واسط فناورانه است که تلاش می‌کند در صورت ایجاد ظرفیت، بلیط را در سریع‌ترین زمان ممکن خریداری کند.</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-3">سفرز هیچ مسئولیتی در قبال عدم امکان سوار شدن به قطار، جریمه یا ابطال بلیط و مشکلات ناشی از اطلاعات اشتباه نخواهد داشت.</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <div className="bg-emerald-500/5 rounded-lg p-3 border border-emerald-500/15 mt-3">
            ...
            <p className="text-sm">در صورتی که ربات سفرز موفق به خرید بلیط نشود، کل مبلغ شامل هزینه بلیط و کارمزد خدمات به صورت کامل به کیف پول کاربر بازگردانده می‌شود.</p>
          </div>
      ...
      content: (
        <>
          ...
          <div className="bg-destructive/10 rounded-lg p-4 border border-destructive/20 mt-3">
            <p className="font-bold text-destructive mb-1 text-sm">🚫 کارمزد سفرز (غیرقابل استرداد)</p>
            <p className="text-sm">کارمزد خدمات هوشمند سفرز در صورت خرید موفق بلیط <strong>به هیچ عنوان قابل استرداد نیست.</strong></p>
            <p className="text-xs mt-2 text-muted-foreground">دلیل: سرویس سفرز وظیفه خود (شکار و خرید موفق بلیط) را انجام داده است. ثبت درخواست در سامانه به منزله پذیرش قطعی این بند توسط کاربر است.</p>
          </div>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-3">سفرز هیچ مسئولیتی در قبال عدم دریافت پیامک به دلایل زیر ندارد:</p>
          <ul className="list-disc pr-6 space-y-1 mt-1">
