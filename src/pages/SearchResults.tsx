...
import { SEARCH_TRAINS, getCityName } from '@/lib/constants';

const trains = SEARCH_TRAINS;
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg font-bold">
                  {language === 'fa' 
                    ? `انتخاب قطار رفت ${getCityName(from, language)} به ${getCityName(to, language)}`
                    : `Select Train from ${getCityName(from, 'en')} to ${getCityName(to, 'en')}`
                  }
                </h1>
              </div>
